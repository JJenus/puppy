  ...
  <div class="position-sticky top-0">
    <div class="text-center pt-5">
      ...
      <div id="account-menu" class="list-group list-group-flush collapse d-md-block">
        <a href="<?=base_url("app/dashboard/details")?>" class="list-group-item list-group-item-action d-flex align-items-center">
          <i class="bx bx-cog fs-xl opacity-60 me-2"></i>
          Accountt Details
        </a>
        <a href="<?=base_url("app/dashboard/security")?>" class="list-group-item list-group-item-action d-flex align-items-center">
          <i class="bx bx-lock-alt fs-xl opacity-60 me-2"></i>
          Security
        </a>
        <a href="<?=base_url("app/dashboard/notifications")?>" class="list-group-item list-group-item-action d-flex align-items-center">
          <i class="bx bx-bell fs-xl opacity-60 me-2"></i>
          Notifications
        </a>
        <a href="<?=base_url("app/dashboard/collections")?>" class="list-group-item list-group-item-action d-flex align-items-center active">
          <i class="bx bx-collection fs-xl opacity-60 me-2"></i>
          My Collections
        </a>
        <a href="<?=base_url("app/dashboard/payment")?>" class="list-group-item list-group-item-action d-flex align-items-center">
