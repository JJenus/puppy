							...
							<div class="d-flex align-items-center">
								...
								<div class="ms-1 ms-lg-6">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-300px" data-kt-menu="true">
										<div class="menu-content fw-bold d-flex align-items-center bgi-no-repeat bgi-position-y-top rounded-top" style="background-image:url('<?=base_url()?>/assets/ media/misc/dropdown-header-bg.jpg')">
											<div class="symbol symbol-45px mx-5 py-5">
												<span class="symbol-label bg-primary align-items-end">
													<img alt="Logo" src="<?=base_url()?>/assets/ media/svg/avatars/001-boy.svg" class="mh-35px" />
												</span>
											</div>
											<div class="">
										...
										<div class="row row-cols-2 g-0">
											<a href="<?=base_url()?>/ profile/overview.html" class="border-bottom border-end text-center py-10 btn btn-active-color-primary rounded-0">
											...
											<a href="<?=base_url()?>/ profile/account.html" class="col border-bottom text-center py-10 btn btn-active-color-primary rounded-0">
											...
											<a href="<?=base_url()?>/ profile/settings.html" class="col text-center border-end py-10 btn btn-active-color-primary rounded-0">
											...
											<a href="<?=base_url()?>/ general/login.html" class="col text-center py-10 btn btn-active-color-primary rounded-0">
